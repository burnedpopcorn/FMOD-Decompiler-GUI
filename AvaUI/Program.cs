...
using static AvaUI.ViewModels.MainViewModel;

namespace FMOD_Decompiler;
...
public class Program
{
    ...
    public static async Task ExtractFSB(string bFolder, string oFolder, string projectname = "Generic-Project")
    {
        bankFolder = bFolder;
        outputProjectPath = oFolder;
        ...
        PushToConsoleLog($"\nConversion Complete!");
        PushToConsoleLog($"Exported Project is at {outputProjectPath}");
